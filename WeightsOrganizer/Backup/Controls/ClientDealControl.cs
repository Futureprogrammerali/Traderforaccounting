...
namespace WeightsOrganizer.Controls
{
    public partial class ClientDealControl : UserControl
    {
        ...
        private void ClientDealControl_Load(object sender, EventArgs e)
        {
            ...
            this.label9.Text = (BLL.ClientDeal.GetAllTotalPrice(DateTime.Now, DateTime.Now)).ToString(); 
            ...
            try
            {
                ...
                else
                {
                  ...
                  // BLL.ClientDeal.InsertClientDeal(0, typeid, manid, amnt, clprc, amnt * clprc, det, TheUnito, tppp.BusinessPrice, combocompany.Text, combotypes.Text);
                   ...
                   BLL.ClientDeal.InsertClientDeal(0, typeid, manid, amnt, clprc, amnt * clprc, det, new MyDateTime(dateTimePicker1.Value), TheUnito, tppp.BusinessPrice, combocompany.Text, combotypes.Text);
                    
                 
                    BLL.Client clo = BLL.Client.GetClientByID(manid); clo.Balance += ((amnt * clprc) - PaidMoney);
                    clo.UpdateClient();
                    //print
