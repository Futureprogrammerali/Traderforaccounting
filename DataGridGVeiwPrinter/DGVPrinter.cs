...
namespace DataGridGVeiwPrinter //AllocationRequest
{    
    ...
    public class DGVPrinter
    {
        ...
        {
            PrintDataGridView(dgv, false);
        }
        public void PrintDataGridView(DataGridView dgv ,bool viewdiaolg)
        {
        ...
        public DialogResult DisplayPrintDialog()
        {
            ...
            return PrePerPrinter().ShowDialog();
        }

        private PrintDialog PrePerPrinter()
        {
            ...
            if (!String.IsNullOrEmpty(printerName)) printDoc.PrinterSettings.PrinterName = printerName;
            return pd;
        }
