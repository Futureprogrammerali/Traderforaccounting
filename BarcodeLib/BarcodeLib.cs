...
namespace BarcodeLib
{
    ...
    public class Barcode: IDisposable
    {
        ...
        {
            get { return Another_Data; }
            set { Another_Data = value; }
        }//AnotherDate
        ...
        internal Image Encode()
        {
            ...
            if (Raw_Data.Trim() == "") 
                throw new Exception("«·—Ã«¡ «œŒ«· »Ì«‰« ");

            if (this.EncodedType == TYPE.UNSPECIFIED) 
                throw new Exception("«·—Ã«¡ Õœœ ‰„ÿ «· ‘›Ì—");
            ...
            switch (this.Encoded_Type)
            {
                ...
                case TYPE.FIM:
                    ...
                    break;
                default: throw new Exception("‰„ÿ  ‘›Ì— €Ì— „œ⁄Ê„");
            }//switch
        ...
        {
            if (Encoded_Value == "") throw new Exception("ÌÃ»  ‘›Ì— «·‰’ ﬁ»· —”„Â");
            Bitmap b = null;
                ...
                case TYPE.ITF14:
                    {
                        ...
                        if (IncludeLabel || this.Another_Data.Length>1)
                            Label_ITF14((Image)b);
        ...
        public byte[] GetImageData(SaveTypes savetype)
        {
            ...
            {
                throw new Exception("ÌÊÃœ Œÿ√ " + ex.Message);
            }//catch  
            return imageData;
        }
        /// <summary>
        ...
        public void SaveImage(Stream stream, SaveTypes FileType)
        {
            ...
            {
                throw new Exception("Œÿ√ Õ›Ÿ «·’Ê—… 2\n\n=======================\n\n" + ex.Message);
            }//catch
        ...
        private Image Label_ITF14(Image img)
        {
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(img))
                {
                    ...
                    //~~~~~~~~
                    string newRawdata ="";
                    if(IncludeLabel) newRawdata=this.RawData;
                    if(this.Another_Data.Length>1)newRawdata+=" "+Another_Data;
                    g.DrawString(newRawdata, font, new SolidBrush(this.ForeColor), (float)(img.Width / 2), img.Height - font.Height + 1, f);
        ...
        private Image Label_Generic(Image img)
        {
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(img))
                {
                    ...
                    if(IncludeLabel) newRawdata=this.RawData;
                    if(this.Another_Data.Length>1) newRawdata+=" "+Another_Data;
                    g.DrawString(newRawdata, font, new SolidBrush(this.ForeColor), new RectangleF((float)0, (float)LabelY, (float)img.Width, (float)font.Height), f);
